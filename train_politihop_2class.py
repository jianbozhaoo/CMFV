...
from models import CMFV, MultiClassFocalLossWithAlpha
...
dir_path = Path('outputs/politihop_2class/')
...
for path in dev_file_paths:
    ...
    dev_centers_list[path] = cal_nwgm_center_attention(graph_rep_model_path, dev_dataloader, nclass, device, feature_num, args.evi_num, n_cluster, politihop_2way=True)
...
train_centers = cal_nwgm_center_attention(graph_rep_model_path, train_tqdm_iterator, nclass, device, feature_num, args.evi_num, n_cluster, politihop_2way=True)
step = 0
